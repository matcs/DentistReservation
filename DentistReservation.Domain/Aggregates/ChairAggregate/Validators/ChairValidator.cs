...
public class ChairValidator : AbstractValidator<Chair>
{
    public ChairValidator()
    {
        ...
        RuleFor(c => c.StartHour).GreaterThanOrEqualTo(0).LessThan(24);
        RuleFor(c => c.StartMinute).GreaterThanOrEqualTo(0).LessThan(59);
        RuleFor(c => c.EndHour).GreaterThanOrEqualTo(0).LessThan(24);
        RuleFor(c => c.EndMinute).GreaterThanOrEqualTo(0).LessThan(59);
